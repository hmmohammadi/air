...
Item {
    ...
    property int dialWidth: 4 //15

    property color backgroundColor: "transparent"
    property color dialColor: "#FF505050"
    property color progressColor: "#945ddd" //"#FFA51BAB"
    ...
    QtObject {
        ...
        property real baseRadius: Math.min(control.width / 2,
                                           control.height / 2)
        property real radiusOffset: internals.isFullDial ? control.dialWidth
                                                           / 2 : control.dialWidth / 2
